...
- Memory/Ollama embeddings: Switch `embedBatch` to the new Ollama embedding endpoint `/api/embed` for improved performance, with a fallback to the old endpoint if it fails.
